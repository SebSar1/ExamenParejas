...
public class LogRastreadorPanel extends JPanel {
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (validarUsuario(usuario, contrasena)) {
                    JOptionPane.showMessageDialog(LogRastreadorPanel.this, "Login Exitoso",
                            "Bienvenido",
                            JOptionPane.INFORMATION_MESSAGE);
                    // Si la validación es exitosa, pasas al siguiente panel
                    PnlRastreador();
                } else {
                    JOptionPane.showMessageDialog(LogRastreadorPanel.this, "Usuario o Contraseña incorrectos",
                            "Error",
    ...
    private void PnlRastreador() {
        try {
            removeAll();
            add(new PnlRastreador());
            revalidate();
            repaint();
        } catch (Exception ex) {
            ex.printStackTrace();
