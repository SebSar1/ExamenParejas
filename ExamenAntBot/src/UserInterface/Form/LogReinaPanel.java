...
public class LogReinaPanel extends JPanel {
    ...
    private void initializeComponents() {
        ...
        btnInfo = new SebButton("Usuario:1      Contraseña:contrasena1");
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (validarUsuario(usuario, contrasena)) {
                    JOptionPane.showMessageDialog(LogReinaPanel.this, "Login Exitoso",
                            "Bienvenido",
                            JOptionPane.INFORMATION_MESSAGE);
                    // Si la validación es exitosa, pasas al siguiente panel
                    ReinaPanel();
                } else {
                    JOptionPane.showMessageDialog(LogReinaPanel.this, "Usuario o Contraseña incorrectos", "Error",
