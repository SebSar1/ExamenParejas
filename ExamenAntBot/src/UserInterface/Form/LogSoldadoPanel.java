...
public class LogSoldadoPanel extends JPanel {
    ...
    private void initializeComponents() {
        ...
        btnInfo = new SebButton("Usuario:4      Contraseña:contrasena4");
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (validarUsuario(usuario, contrasena)) {
                    JOptionPane.showMessageDialog(LogSoldadoPanel.this, "Login Exitoso",
                            "Bienvenido",
                            JOptionPane.INFORMATION_MESSAGE);
                    // Si la validación es exitosa, pasas al siguiente panel
                    PnlSoldado();
                } else {
                    JOptionPane.showMessageDialog(LogSoldadoPanel.this, "Usuario o Contraseña incorrectos", "Error",
