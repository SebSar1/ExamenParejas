...
public class SAPnlReina extends JPanel {

    private Image saBackgroundImage;
    private SebButton saBtnRegresar;
    private SebButton saBtnCrear;
    private SebButton saBtnEliminar;
    private SebButton saBtnEditar;
    private SebButton saBtnAlimentar;
    ...
    private void initializeComponents() {
        ...
        saBtnCrear = new SebButton("Crear");
        saBtnEditar = new SebButton("Editar");
        saBtnEliminar = new SebButton("Eliminar");
        saBtnAlimentar = new SebButton("Alimentar");
    }
    ...
    private void showHormigasTabla() {
        try {
            ...
            JLabel lblTituloTabla = new JLabel("Hormigas del Ejército");
            ...
            JPanel panelTablaConTitulo = new JPanel(new BorderLayout());
            panelTablaConTitulo.add(lblTituloTabla, BorderLayout.NORTH); // Agregar el título en la parte superior
            panelTablaConTitulo.add(new JScrollPane(table), BorderLayout.CENTER); // Agregar la tabla en el centro
            ...
            saPnlTabla.add(panelTablaConTitulo);
    ...
    private void setupLayout() {
        ...
        panelTablaCentral.add(saPnlTabla);
        ...
        panelBotonera.add(saBtnCrear);
        panelBotonera.add(saBtnEditar);
        panelBotonera.add(saBtnEliminar);
        panelBotonera.add(saBtnAlimentar);
    ...
    private void setupActions() {
        ...
        saBtnCrear.addActionListener(e -> VentanaCrear());
        saBtnEditar.addActionListener(e -> VentanaEditar());
        saBtnAlimentar.addActionListener(e -> PnlAlimentar());
        saBtnEliminar.addActionListener(e -> VentanaEliminar());
    }
