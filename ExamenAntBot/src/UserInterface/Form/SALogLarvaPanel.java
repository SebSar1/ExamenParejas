...
public class SALogLarvaPanel extends JPanel {
    ...
    private void initializeComponents() {
        ...
        btnInfo = new SebButton("Usuario:3      Contraseña:contrasena3");
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (validarUsuario(usuario, contrasena)) {
                    JOptionPane.showMessageDialog(SALogLarvaPanel.this, "Login Exitoso",
                            "Bienvenido",
                            JOptionPane.INFORMATION_MESSAGE);
                    // Si la validación es exitosa, pasas al siguiente panel
                    PanlLarva();
                } else {
                    JOptionPane.showMessageDialog(SALogLarvaPanel.this, "Usuario o Contraseña incorrectos", "Error",
