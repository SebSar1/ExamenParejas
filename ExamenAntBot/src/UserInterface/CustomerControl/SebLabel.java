...
public class SebLabel extends JLabel {
    ...
    private Color color = new Color(8, 18, 64); // Color del texto (por defecto azul)
    private int alignment = SwingConstants.LEFT; // Alineación del texto (por defecto a la izquierda)
    private Font font = new Font("Times New Roman", Font.BOLD, 26); // Fuente del texto (tipo de letra y tamaño)
    ...
    private void customizeLabel() {
        ...
        setOpaque(true); // Hace que la etiqueta sea transparente
        setBackground(Color.white); // Establece el fondo de la etiqueta como transparente
    }
}
