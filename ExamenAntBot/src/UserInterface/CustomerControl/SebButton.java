...
public class SebButton extends JButton implements MouseListener {
    ...
    private void setupButton() {
        ...
        setFont(new Font("Algerian", Font.BOLD, 20)); // Establece la fuente del texto del botón
        setForeground(Color.WHITE); // Establece el color del texto
        setBackground(new Color(8, 18, 64)); // Establece el color de fondo del botón (rojo claro)
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gradientPaint = new GradientPaint(0, 0, new Color(8, 18, 64), 0, height,
                new Color(8, 18, 64));
        g2d.setPaint(gradientPaint); // Establece el degradado como color de fondo
        g2d.fillRoundRect(0, 0, width, height, 0, 0); // Dibuja un rectángulo redondeado con el degradado
